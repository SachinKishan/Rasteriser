...
public:
    ...
    static const Rgb kBlack, kWhite, kRed, kGreen, kBlue, kPurple, kCyan, kYellow; // Preset colors 
...
const Image::Rgb Image::kYellow = Image::Rgb(1, 1, 0);
const Image::Rgb Image::kPurple = Image::Rgb(1, 0, 1);
const Image::Rgb Image::kCyan = Image::Rgb(0, 1, 1);
